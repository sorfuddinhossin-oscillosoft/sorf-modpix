...
$result = $shDB->selectOnMultipleCondition($selectOrder,'`order`');
		...
		<div class="innerWhiteContainer">
			...
			<div class="leftFloat div100">
				...
				<table cellpadding="3" cellspacing="0" style="table-layout:fixed; width:100%;">
					<tr>
						<td align="left" class="tableHeader" style="width:45%; padding-left:2%;">Order Date</td>
						<td align="left" class="tableHeader" style="width:20%">Total Payment</td>
						<td align="left" class="tableHeader" style="width:20%">Status</td>
						<td align="center" class="tableHeader" style="width:15%">Action</td>
					</tr>					
					<?php
					...
					<tr>
						...
						<?php echo $log->timewebformat($ord['ordertime']);?></td>
