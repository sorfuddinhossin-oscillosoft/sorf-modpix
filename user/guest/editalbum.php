						...
						<div class="content">
							<div>
								...
								<?php
									if(isset($_REQUEST['albumname'])){
										...
										$dataforalbum = array(											
											...
											'securitycode' => trim($_REQUEST['securecodee']),
											'ispublic' => $ispublic																
											);
										...
										$dir = str_replace(chr(92),chr(47),getcwd());
											...
											$newdir = $dir.'/profile/'.$album['album_create_by'].'/'.$album['id'].'_'.$albumNewName;
											$olddir = $dir.'/profile/'.$album['album_create_by'].'/'.$album['id'].'_'.$albumOldName;
										...
										if($result!=false){
												...
												if($newdir!=$olddir){													
													if(rename($olddir, $newdir)){
														echo 'Edit successful. <a href="'.$log->baseurl.'user/index.php?pg=myalbum">Go to collection</a>';
													}else{
														echo 'Edit is not successful. Try later.<a href="'.$log->baseurl.'user/index.php?pg=myalbum">Go to collection</a>';
													}
												}else{
													echo 'Edit successful. <a href="'.$log->baseurl.'user/index.php?pg=myalbum">Go to album</a>';
												}										
										}	
								...
								<form action="" method="POST" name="albumAddForm" enctype="multipart/form-data" id="photocollectionform">
									...
									<?php if($owneremail){?>
									<label>Owner Details</label>&nbsp;</small><br />
									...
									<input class="mandatory"  type="text" name="securecodee" id="securecodee"  value="<?php echo $album['securitycode'];?>"><br />
