						...
						<div class="content">
							<div>
								...
								<?php
									if(isset($_REQUEST['albumname'])){
										...
										$dataforalbum = array(											
											...
											'album_status' => $_REQUEST['album_status'],											
											'ispublic' => $ispublic																
											);
								...
								<form action="" method="POST" name="albumAddForm" enctype="multipart/form-data" id="photocollectionform">
									...
									<br /><label>Album Status</label>
									<input type="radio" name="album_status" value="1" <?php if($album['album_status'] == 1){?> checked="checked" <?php } ?>> &nbsp; Active <input type="radio" name="album_status" value="0" <?php if($album['album_status'] == 0){?> checked="checked" <?php } ?>> &nbsp; Archived<br />
