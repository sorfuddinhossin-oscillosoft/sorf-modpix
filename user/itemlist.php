...
$itemData = $shDB->selectOnMultipleCondition($itemData,'prod_item','name','ASC');
		...
		<div class="innerWhiteContainer">
			...
			<?php if($itemData) { ?>
					...
					<tr>
						...
						<td><?php echo $settings['currency']. number_format($idata['addsidecost'],2,'.','');?></td>
						<td><?php echo $settings['currency']. number_format($idata['basicprice'],2,'.','');?></td>
