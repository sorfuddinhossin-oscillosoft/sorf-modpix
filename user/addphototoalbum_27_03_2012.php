						...
						<div class="content">
							<table class="div100" cellpadding="4" cellspacing="0">
								...
								for($i=0;$i<sizeof($photo);$i++)
									{										
										echo '<a href="'.$useralbumurl.$photo[$i]['image'].'" class="veryeasylightbox" title="'.$photo[$i]['image'].'" rel="'.$useralbumurl.$photo[$i]['image'].'" >
										<div class="thumbimagediv"  id="collImageId'.$photo[$i]['id'].'" ><img src="'.$useralbumthumburl.$photo[$i]['image'].'" class="photoThumb" />
