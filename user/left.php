<div id="leftMenu">
	...
	<?php 
		...
		<li><a class="<?php echo $cms; ?>" title="CMS Pages" href="<?php echo $log->baseurl;?>user/index.php?pg=cms">CMS Pages</a></li>
		<li><a class="<?php echo $hpss; ?>" title="CMS Pages" href="<?php echo $log->baseurl;?>user/index.php?pg=hpss">Home Page Slide Show</a></li>
