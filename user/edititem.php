...
// edit item and option
					...
					if(isset($_REQUEST['itemid'])){
						$destinationUrl = trim($_REQUEST['destinationUrl']);
						...
						if($destinationUrl == 1){
							echo '<script>location.href="'.$log->base_url.'index.php?pg=productdetails&msg=success&tab=items&id='.$prodId.'";</script>';
						}	
					}
		...
		<div class="innerWhiteContainer">
			...
			<div class="leftFloat div100">
				<table cellpadding="5" cellspacing="0" style="width:100%; padding-left:10px; padding-right:10px;">
					...
					<input type="hidden" name="destinationUrl" value="<?php echo ((isset($_REQUEST['origin']) && $_REQUEST['origin'] == 1)?$_REQUEST['origin'] : 0);?>">
					...
					<table width="100%">
						...
						<tr>
							<td colspan="6" style="text-align: center; font-weight: bold;color: green;">
								<div class="messSuccess" style="text-align: center;">Items has been successfully updated.</div>
							</td>
						</tr>
						<?php } ?>
						<tr>
							<td colspan="6" style="text-align: right;">
								<input type="button" value="Update Item" id="addProductItemTop">
					...
					<tr>
						...
						<td><input type="text" name="addsidecost" style="width:89px;" value="<?php echo number_format($itemDetailsData['addsidecost'],2,'.','');?>"></td>
						<td><input type="text" name="itemcost" style="width:43px;" value="<?php echo number_format($itemDetailsData['basicprice'],2,'.','');?>"></td>
					</tr> 
					...
					<tr id="itemTr<?php echo $iOption['id'];?>">
						...
						<td align="left">
							<input type="text" name="optioncost<?php echo $iOption['id'];?>" style="width:50px;" value="<?php echo number_format($prodItemOptionSelectData['cost'],2,'.','');?>">
						</td>
					</tr>	
					<?php 
						}else{ ?>
