					...
					<tr>
						...
						<form action="<?php echo $log->base_url;?>index.php?pg=albuminvitation&id=<?php echo $_REQUEST['id'];?>" method="post" id="guestInvitationForm">
							...
							<div style="float: left;">	
								<textarea class="ckeditor" type="text" name="albumDescription" style="width:366px; height:70px;" id="albumDescription"><?php echo $album['description'];?></textarea><br />
							</div>
						...
						<td style="width:35%; background:#EAF0F0" valign="top">						
							...
							<!-- end of pending request -->
								...
								<div align="center" class="leftFloat div100">
											...
											<input onfocus="if ( this.value == this.defaultValue ) this.value = ''" onblur="if ( this.value == '' ) this.value = this.defaultValue"  style="width:167px;" type="text"  rel="admin" id="addMulEmailBox" class="guestEmailTextBox" value="Enter a valid email">
							...
							<div id="pending">
							<a class="checkall" id="checkallpending">Check All</a><a class="checkall" id="sendnotifyemail" rel="admin">Send Notification Email</a>
								<?php
								$dataSelectGuestEmail = array(		
									'notified' => 0,
									'album_id' => $_REQUEST['id']
							...
							<a class="checkall" id="checkallconfirmed">Check All</a><a class="checkall" rel="admin" id="notifyagain">Notify Again</a>
								<?php
								$dataSelectGuestEmail = array(		
									'notified' => 1,
									'album_id' => $_REQUEST['id']
