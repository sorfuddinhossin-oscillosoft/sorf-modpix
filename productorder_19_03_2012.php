...
<h1 class="pagetitle"><?php echo $productItem['name'];?></h1>
...
<input type="hidden" name="imgid" value="<?php echo $_GET['imgid'];?>">
		...
		foreach($productItemOptions as $k=>$productItemOption){
			...
			if(in_array($productItemOption['name'], $existsOptionName)){
				...
				$html .='<input type="radio" name="'.$optName.'" value="'.$productItemOption['prodoptId'].'">&nbsp;&nbsp;'.$productItemOption['value']."<br />";
			
			}else{
				$html .='<label>'.$productItemOption['name'].'</label>';
				...
				$html .='<input type="radio" name="'.$optName.'" value="'.$productItemOption['prodoptId'].'">';
				...
				if($productItemOption['cost']!=0){
					$html .= '&nbsp;&nbsp;'.$productItemOption['value'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="color:orange"> '.$settings['currency'].'&nbsp;'.$productItemOption['cost'].'</strong><br />';
				}else{
