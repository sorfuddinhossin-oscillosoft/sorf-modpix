...
<meta name="description" content="If you are looking for best wedding photographer then Here you will find a complete online wedding photography, photo hosting, Metal Printing, photo sharing and printing service that can be tailored to meet your individual wedding requirements." />
...
<!--[if IE]>
<link href="<?php echo $css; ?>stylesheet_ie.css" rel="stylesheet" type="text/css">
<![endif] -->
...
<script type="text/javascript" src="<?php echo $js; ?>jquery.jscroll.js"></script>
...
?>
	...
	<div id="headerwrapper">
		...
		<div id="logo" align="left">
        	<a href="<?php echo $log->baseurl;?>index.php"><img width="250" height="78" src="<?php echo $log->baseurl;?>images/modpix_logo.png" border="0"/></a>
        </div>
		<!--end of : logo-->
		</div>
