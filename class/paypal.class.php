...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<p class=\"greenMessage\">Please wait, your order is being processed and you";
      echo " will be redirected to the paypal website.</p>\n";
      ...
      echo "<center>If you are not automatically redirected to ";
      echo "paypal within 5 seconds...\n";
      echo "<input type=\"submit\" value=\"Click Here\"></center><br /><br />\n";
