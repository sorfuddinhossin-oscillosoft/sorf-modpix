...
class sh_DB {
	 ...
	 public $database_logon = 'oscillos_modfix';		//Database NAME
	 public $username_logon = 'oscillos_modpix';		//Database USERNAME
	 public $password_logon = 'newmodpix123';			//Database PASSWORD
