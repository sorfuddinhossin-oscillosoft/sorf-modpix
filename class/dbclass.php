...
class sh_DB {
	 ...
	 public $database_logon = 'modpixco_website';		//Database NAME
	 public $username_logon = 'modpixco_sam';		//Database USERNAME
	 public $password_logon = 'AnH9iS#r=!F8';			//Database PASSWORD
...
function selectOnMultipleConditionWithPaging($data = '',$table = '',$orderby = '', $way = ''){
...
function searchOnMultipleCondition($data = '',$table = '',$orderby = '', $way = ''){
		...
		//added for not colloect archive id. bof
				$qry .= ") AND  album_status=1";	
				//added for not colloect archive id. eof
		if($orderby!=''){
			if($way == ''){
