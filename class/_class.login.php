...
class logmein{
	...
	var $database_logon = 'oscillos_modfix';		//Database NAME
	var $username_logon = 'oscillos_modpix';		//Database USERNAME
	var $password_logon = 'newmodpix123';		//Database PASSWORD
	
	var $baseurl = 'http://demo.oscillosoft.com/modpix_final/';
	var $rootDirectory = '/home/oscillos/public_html/demo/modpix_final/';
	//table fields
