<div id="content">
		...
		<div class="right">
			...
			<div id="gallery" style="display: block; height: 423px;margin-left: -46px;overflow: hidden;width: 486px;border:2px solid white;">
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>images/slider_image/img_1.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_2.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_3.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_4.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_5.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_6.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_7.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_8.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_9.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_10.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_11.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_12.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_13.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_14.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_15.jpg"/></a>
				<a href="#" style="clear:both"><img title="" alt="" rel="" src="<?php echo $log->baseurl?>/images/slider_image/img_16.jpg"/></a>
