...
?> 
aklsdjfklajk
<h1 class="pagetitle">Order Details</h1>
...
<div id="photos" class="tabDiv">
			...
			<?php if($orderProduct){?>
				<table cellpadding="3" cellspacing="0" style="table-layout:fixed; width:100%;">
					<tr>
						<td align="left" class="tableHeader" style="padding-left:2%;">Order Item and Invoice Details</td>
						<td align="right" valign="bottom" class="tableHeader" style="width:48%; padding-right:2%;">Status : <?php echo $order['status'];?>
							...
							if($orderProduct){
								if($order['isalbum']==1){
												foreach ($orderProduct as $ordProd){
														...
														<li class="cartPhotoImgHolder" style="border:0px;">
														<table cellpadding="3" cellspacing="0" style="table-layout:fixed; width:100%;">
														<tr>
									...
									<td align="center" class="botBorder2" style="width:22%;padding-right:15px;"><strong>Image Id</strong></td>
														...
														if($imageInProductOrder){
															...
															$albumName = str_replace(' ','_',$imageDetails[0]['album_name']);
																...
																echo '<li style="border:none;" class="cartPhotoImgHolder" id="cartPhotoImgHolder_'.$ordProductImg['id'].'">';
																echo '<table cellpadding="3" cellspacing="0" style="table-layout:fixed; width:100%;">
															<tr>								
