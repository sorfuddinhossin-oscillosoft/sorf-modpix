...
?>
<h1 class="pagetitle">Album Order : <?php echo $useralbum['name'];?> </h1>
...
<table width="100%">
	...
	<label>Album name :</label> <?php echo $useralbum['name'];?><br />
	...
	<?php echo 'Album item id '.$_REQUEST['itemid'].'<br />';?>
		...
		$datainsert = array(
			...
			$selectBillingAddress = $selectBillingAddress[0];
					...
					$datainsert = array(
						...
						$selectOrderImgDatainAlbum = array(		
							'useralbum_id' => $_REQUEST['albumid']
							);									
						$dataInUserAlbumImg = $shDB->selectOnMultipleCondition($selectOrderImgDatainAlbum,'useralbum_img');
			...
			if($success===true){
				echo 'Thanks for ordering album. Our legal people will contact with you soon.<br /><br />
					  <a class="addtocart" href="'.$log->base_url.'index.php?pg=invitation">Back to Collection</a>';
			}else{echo 'Order not successful. Please try later.<br /><br />
					  <a class="addtocart" href="'.$log->base_url.'index.php?pg=invitation">Go to Collection</a>';}		
	 }
