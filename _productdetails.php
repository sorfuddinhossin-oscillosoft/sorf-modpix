...
<div id="featured" style="height:auto"> 
							  ...
							  foreach($prodImage as $prodimg){	?>	
									...
									<img title="" alt="" rel="<h3>Flowing Rock</h3>" src="<?php echo $log->baseurl;?>user/product/<?php echo $productDetails['catid'];?>_<?php echo $prodNameDir; ?>/<?php echo $prodimg["name"]?>" style="width:830px;height:auto"/>
										</a>
										<?php 	}							 
							  ?>
